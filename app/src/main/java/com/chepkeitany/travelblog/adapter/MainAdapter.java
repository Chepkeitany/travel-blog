package com.chepkeitany.travelblog.adapter;
...
import com.chepkeitany.travelblog.R;
import com.chepkeitany.travelblog.http.*;
...
public class MainAdapter extends ListAdapter<Blog, MainAdapter.MainViewHolder> {
    ...
    public MainViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.activity_item_main, parent, false);
